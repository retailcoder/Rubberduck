...
namespace Rubberduck.ComClientLibrary.CI
{
    ...
    //    public HeadlessInspector(RubberduckParserState state, IInspector inspector)
    //    {
    //        _state = state;
    ...
    //        {
    //            var results = _inspector.FindIssuesAsync(_state, CodeInspectionSeverity.Error, CancellationToken.None).ConfigureAwait(false).GetAwaiter().GetResult();
    ...
    public class RubberduckCI : IRubberduckCI
    {
        ...
        public RubberduckCI(IHeadlessImportService importService, ITestEngine testEngine)
        {
